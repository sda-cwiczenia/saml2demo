...
// Zestaw klas konfiguracyjnych do saml2
@Configuration
public class SamlSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public ExtendedMetadataDelegate idpMetadata()
        ...
        HTTPMetadataProvider httpMetadataProvider = new HTTPMetadataProvider(backgroundTaskTimer, new HttpClient(), ONELOGIN_METADATA_URL.concat(getAppId()));
